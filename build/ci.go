...
import (
	...
	"github.com/hubertat/go-ethereum/crypto/signify"
	"github.com/hubertat/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/hubertat/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/hubertat/go-ethereum/internal/version.gitDate="+env.Date)
	}
